...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <title>Contractor Universe</title>
      <style type="text/css">
         html { background-color: #f5f7f9; margin: 0; padding: 0; }
         ...
         body, #bodyTable { background-color: #f5f7f9; }
         #emailHeader { background-color: #282727; }
         #emailBody { background-color: #FFFFFF; }
         #emailFooter { background-color: #343a40; }
        ...
        .table-border > tbody > tr > td{ border:1px solid #ddd; padding:8px;}
        .table-sm{font-size:80%;}
        .table-borderless th{ border-bottom:2px solid #ddd; padding:5px;}
        .table-borderless td{ padding:5px;}
            ...
            <tr>
               <td align="center" valign="top" id="bodyCell">               
                  <table bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="670" id="emailBody">                   
                     <tr>
                        <td align="center" valign="top" style="border-bottom:3px solid #e1eaf1;">                          
                         @include('backend.emails.header') 
                        </td>
                     </tr>                     
                     <!-- // MODULE ROW -->
                     <tr>
                              ...
                              <tr>
                                 <td align="center" valign="top">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="670"
                                       class="flexibleContainer" style="min-height:360px;">
                                       <tr>
                                          <td align="center" valign="top" width="670"
                                             class="flexibleContainerCell">
                                             @include('backend.emails.contractor_lead')
                                          </td>
                                       </tr>
                                    </table>
                                    <!-- // FLEXIBLE CONTAINER -->
